...
const Navbar = ({ navOpen }) => {
  ...
  const initActiveBox = () => {
    ...
    activeBox.current.style.left = lastActiveLink.current.offLeft + "px";
    activeBox.current.style.width = lastActiveLink.current.offWidth + "px";
    activeBox.current.style.height = lastActiveLink.current.offHeight + "px";
  };
