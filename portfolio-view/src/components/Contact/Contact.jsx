      ...
      <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
        <div className="mb-12 lg:mb-0 lg:flex lg:flex-col">
          ...
          <p className="mb-8 mt-3 max-w-[50ch] text-zinc-400 lg:max-w-[30ch]">
            Excited to build something amazing? Let us make it happen <br />
          ...
          <div className="mt-auto flex items-center gap-2">
            {socialLinks.map(({ href, icon }, key) => (
              <a
                ...
                href={href}
                target="_blank"
                className="grid h-12 w-12 place-items-center rounded-lg ring-2 ring-inset ring-zinc-50/5 transition-[background-color,color] hover:bg-zinc-50 hover:text-zinc-950 active:bg-zinc-50/80"
              >
                {icon}
              </a>
            ))}
